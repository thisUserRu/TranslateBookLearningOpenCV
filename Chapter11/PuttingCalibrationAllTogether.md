...
int main(int argc, char* argv[]) {
	...
	while(successes < n_boards) {
		...
		// Пропуск board_dt кадров предоставленых пользователем,
		...
		if(frame++ % board_dt == 0) {
			...
			// Приполучении хорошего представления доски, добавить в коллекцию
			// 
	...
	// Матрица внутренних параметров должна быть проинициализированна
