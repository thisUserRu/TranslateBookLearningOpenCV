...
На первый взгляд может показаться, что у данной функции слишком простой набор аргументов; но это не так – на самом деле данная функция выполняет массу полезных вещей. Исходный массив *src* может быть ![Формула 11- не найдена](Images/Frml_11_.jpg)×N или N×![Формула 11- не найдена](Images/Frml_11_.jpg) (для ![Формула 11- не найдена](Images/Frml_11_.jpg) = 2, 3 или 4); он также может быть 1×N или N×1 в массиве с ![Формула 11- не найдена](Images/Frml_11_.jpg) = 2, 3 или 4 канала (N может быть любым числом; по существу это точки для преобразования, которые заполняют матрицу *src*). Конечный массив *dst* может быть любого типа с дополнительным ограничением по размерности ![Формула 11- не найдена](Images/Frml_11_.jpg) – она должна быть равна ![Формула 11- не найдена](Images/Frml_11_.jpg), ![Формула 11- не найдена](Images/Frml_11_.jpg) – 1 или ![Формула 11- не найдена](Images/Frml_11_.jpg) + 1.

Когда размерность исходного ![Формула 11- не найдена](Images/Frml_11_.jpg) и конечного ![Формула 11- не найдена](Images/Frml_11_.jpg) равны, происходит просто копирование (и, если необходимо, транспонирование). Если ![Формула 11- не найдена](Images/Frml_11_.jpg) > ![Формула 11- не найдена](Images/Frml_11_.jpg), то элементы *dst* вычисляются за счет деления всех кроме последних элементов соответствующего вектора *src* на последний элемент этого вектора (т.е. предполагается, что *src* содержит однородные координаты). Если ![Формула 11- не найдена](Images/Frml_11_.jpg) < ![Формула 11- не найдена](Images/Frml_11_.jpg), то происходит копирование точек, только каждый вектор массива *dst* на конце будет содержать 1 (т.е. вектора из *src* расширяются до однородных координат). 

Одним словом, при работе с данной функцией стоит принимать во внимание, что могут быть случаи (при N < 5), когда исходная и конечная размерность неодинакова. В этом случае функция вернет ошибку. Столкнувшись с данной ситуацией, необходимо дополнить матрицы фиктивными значениями. Кроме того, пользователь может передавать многоканальные матрицы Nx1 и 1xN, с числом каналов ![Формула 11- не найдена](Images/Frml_11_.jpg) (![Формула 11- не найдена](Images/Frml_11_.jpg)). Функция *cvReshape()* может быть использована для преобразования одноканальной матрицы к многоканальной без копирования данных.
...
Для радиальных искажений характерно, что искажение в (оптическом) центре фотоприёмника 0 и увеличивается по мере продвижения к окраине. На практике данное искажение не велико и может быть охарактеризовано несколькими первыми членами разложения в ряд Тейлора вокруг *r = 0*. (Ряд Тейлора – это математический метод для представления (потенциально) сложной функции в виде полинома подобного значения приближенной функции, по меньшей мере, в малой окрестности некоторой определенной точки (чем больше элементов будет задействовано, тем более точный результат будет получен). В рассматриваемом случае возникла необходимость расширения искажений до полинома в окрестности *r = 0*. Данный полином имеет следующий общий вид: ![Формула 11- не найдена](Images/Frml_11_.jpg), а для рассматриваемого случая при *f(r) = 0* и *r = 0* следует, что ![Формула 11- не найдена](Images/Frml_11_.jpg) = 0. Кроме того, функция должна быть симметричной в *r*, поэтому только коэффициенты четных степеней *r* должны быть отличны от нуля. Из всего этого следует, что для описания радиальных искажений необходимо использовать коэффициенты ![Формула 11- не найдена](Images/Frml_11_.jpg), ![Формула 11- не найдена](Images/Frml_11_.jpg) и (иногда) ![Формула 11- не найдена](Images/Frml_11_.jpg)). Для дешевых веб-камер обычно используются первые два члена; первый условно именуется ![Формула 11- не найдена](Images/Frml_11_.jpg), а второй ![Формула 11- не найдена](Images/Frml_11_.jpg). Для сильно искаженных веб-камер, также необходимо задействовать и третий член ![Формула 11- не найдена](Images/Frml_11_.jpg). В общем, радиально расположенные точки будут масштабированы в соответствии со следующими уравнениями:

![Формула 11- не найдена](Images/Frml_11_.jpg)

![Формула 11- не найдена](Images/Frml_11_.jpg)

где (x, y) - это оригинальное положение (на фотоприёмнике) искаженной точки, а (![Формула 11- не найдена](Images/Frml_11_.jpg), ![Формула 11- не найдена](Images/Frml_11_.jpg)) – это новое положение после коррекции. На рисунке 11-4 показано смещение прямоугольной сетки, которое вызвано радиальными искажениями. Внешние точки на внешней стороне прямоугольной сетки все больше смещаются внутрь при увеличении радиального расстояния от оптического центра.
...
Тангенциальное искажение минимально характеризуется двумя дополнительными параметрами ![Формула 11- не найдена](Images/Frml_11_.jpg) и ![Формула 11- не найдена](Images/Frml_11_.jpg):
...
Таким образом, в общей сложности в работе с данными искажениями будут необходимы только пять коэффициентов. В работе с OpenCV все пять коэффициентов образуют *вектор искажений*; этот вектор просто матрица 5×1, содержащая ![Формула 11- не найдена](Images/Frml_11_.jpg), ![Формула 11- не найдена](Images/Frml_11_.jpg), ![Формула 11- не найдена](Images/Frml_11_.jpg), ![Формула 11- не найдена](Images/Frml_11_.jpg) и ![Формула 11- не найдена](Images/Frml_11_.jpg) (именно в таком порядке). На рисунке 11-6 показано влияние тангенциального искажения на фронтально внешнюю прямоугольную сетку точек. Точки смещаются эллиптически согласно функции положения и радиуса.
