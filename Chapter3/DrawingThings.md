...
Следующие два аргумента не обязательны. Параметр *thickness* это толщина линии (в пикселях), а *connectivity* устанавливает тип сглаживания. Тип сглаживания по умолчанию 8 - хорошо сглаженная линия. Можно также установить 4, тогда линия будет менее аккуратной, но зато времени на рисование будет потрачено намного меньше. 
